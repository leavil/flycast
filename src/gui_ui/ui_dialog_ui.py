...
# Form implementation generated from reading ui file 'b:\APPLICACION\flycast-feature-model\FlyCast\src\gui_ui\ui_dialog.ui'
#
...
"}")
        self.bn_min.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("b:\\APPLICACION\\flycast-feature-model\\FlyCast\\src\\gui_ui\\../doc/Minimalistic-Flat-Modern-GUI-Template/icons/1x/hideAsset 53.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("b:\\APPLICACION\\flycast-feature-model\\FlyCast\\src\\gui_ui\\../doc/Minimalistic-Flat-Modern-GUI-Template/icons/1x/closeAsset 43.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.bn_west.setText(_translate("Dialog", "Actualizar"))
